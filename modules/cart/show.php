                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <p id="price"><?php echo currency_format($item['price']); ?></p>
                                        </td>
                                        <td>
                                            <input type="number" data-id=" <?php echo $item['id'] ?>" max="10" min="1" name="qty[<?php echo $item['id']; ?>]" value="<?php echo $item['qty']; ?>" class="num-order">
                                        </td>
                                        <td id="sub_total_<?php echo  $item['id'] ?>">
